...
<p>You can order the deck in <strong>any order you want</strong>. Initially, all the cards start <strong>face down</strong> (unrevealed) in one deck.</p>
...
<p>Return <em>an ordering of the deck that would reveal the cards in <strong>increasing order</strong></em>.</p>

<p><em>Note</em> that the first entry in the answer is considered to be the top of the deck.</p>
